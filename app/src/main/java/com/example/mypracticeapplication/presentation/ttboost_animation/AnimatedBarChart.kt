...
fun AnimatedBarChart(
    ...
    Canvas(modifier = modifier.fillMaxSize()) {
        ...
        // Use standard for loop to avoid iterator allocation in every frame
        for (index in barData.indices) {
            ...
            // Restore the per-bar gradient to maintain visual correctness.
            // Although Brush creation is slightly expensive, it's necessary for the
            // gradient to match the bar's dynamic height as per original code.
