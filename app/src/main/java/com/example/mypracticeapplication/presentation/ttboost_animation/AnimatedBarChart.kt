 ...
 * @param entranceProgress Animation progress for bar entrance provider (0.0 to 1.0)
...
fun AnimatedBarChart(
    ...
    // Access state directly to avoid property delegation overhead in high-frequency draws
    ...
    // Pre-allocate constant objects outside the draw loop
