...
fun FireworksScreen(
    ...
    val rocketTrailPath = remember { Path() } // Cache Path object to avoid per-frame allocations
                ...
                Canvas(modifier = Modifier.fillMaxSize()) {
                    ...
                    fireworks.forEach { firework ->
                        ...
                        if (fireworkProgress < firework.explosionDelay) {
                            ...
                            // Draw rocket trail
                            rocketTrailPath.rewind() // Reuse cached Path
                            rocketTrailPath.apply {
                        ...
                        // Explosion phase
                            ...
                            // Use pre-calculated sparks from the Firework object
...
private fun generateFireworks(count: Int): List<Firework> {
    return List(count) { index ->
        ...
        // Pre-generate sparks for this firework to avoid per-frame allocations
