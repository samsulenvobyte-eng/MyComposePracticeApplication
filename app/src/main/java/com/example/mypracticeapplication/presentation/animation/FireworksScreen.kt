        ...
        Box(
            ...
            Canvas(modifier = Modifier.fillMaxSize()) {
                ...
                repeat(starCount) {
                    ...
                    drawCircle(
                        color = Color.White,
                        alpha = random.nextFloat() * 0.5f + 0.3f, // Bolt: Use alpha parameter instead of Color.copy
                        radius = starSize,
                        center = Offset(x, y)
                    )
                }
            ...
            if (isPlaying) {
                Canvas(modifier = Modifier.fillMaxSize()) {
                    ...
                    if (progress < 0.7f) {
                        ...
                        // Bolt: Standard for loop instead of .forEach to avoid iterator allocation
                        for (i in burstParticles.indices) {
                            ...
                            drawCircle(
                                ...
                                alpha = alpha, // Bolt: Use alpha parameter instead of Color.copy
                                radius = currentSize,
                                center = Offset(x, y)
                            )
                            ...
                            if (burstProgress < 0.5f) {
                                ...
                                drawCircle(
                                    color = Color.White,
                                    alpha = alpha * 0.5f, // Bolt: Use alpha parameter instead of Color.copy
                    ...
                    for (i in fireworks.indices) {
                        ...
                        if (fireworkProgress < firework.explosionDelay) {
                            ...
                            // Draw rocket trail
                            // Bolt: Use pre-allocated trailPath and .reset() instead of creating a new Path() every frame
                            trailPath.reset()
                            ...
                            drawPath(
                                ...
                                alpha = 0.8f, // Bolt: Use alpha parameter instead of Color.copy
                        ...
                        // Explosion phase
                            ...
                            // Bolt: Use pre-calculated sparks instead of generating them every frame
                            ...
                            for (j in sparks.indices) {
                                ...
                                drawCircle(
                                    color = spark.color,
                                    alpha = sparkleAlpha, // Bolt: Use alpha parameter instead of Color.copy
                                ...
                                if (explosionProgress < 0.6f) {
                                    drawCircle(
                                        color = spark.color,
                                        alpha = sparkleAlpha * 0.3f, // Bolt: Use alpha parameter instead of Color.copy
                                        radius = spark.size * 2,
                                        center = Offset(sparkX, sparkY)
                                    )
                                }
                            ...
                            if (explosionProgress < 0.15f) {
                                ...
                                drawCircle(
                                    color = Color.White,
                                    alpha = flashAlpha * 0.8f, // Bolt: Use alpha parameter instead of Color.copy
...
private fun generateFireworks(count: Int): List<Firework> {
    return List(count) { index ->
        ...
        // Pre-generate sparks to avoid per-frame allocation in Canvas
