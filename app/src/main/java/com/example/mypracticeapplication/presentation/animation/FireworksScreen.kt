...
// Data class to store pre-calculated star info
...
fun FireworksScreen(
    ...
    val trailStroke = remember { Stroke(width = 3f) }
    ...
    Column(
        ...
        Box(
            ...
            // Stars background - Cached with drawWithCache
            Spacer(
                modifier = Modifier
                    .fillMaxSize()
                    .drawWithCache {
