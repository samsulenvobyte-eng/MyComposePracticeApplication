...
fun FireworksScreen(
    ...
    Column(
        ...
        Box(
            ...
            // Stars background - optimized with drawWithCache to avoid re-calculating positions every frame
            Spacer(
                modifier = Modifier
                    .fillMaxSize()
                    .drawWithCache {
                        ...
                        onDrawBehind {
                            starData.forEach { (pos, starSize, alpha) ->
                                drawCircle(
                                    color = Color.White,
                                    alpha = alpha,
                                    radius = starSize,
                ...
                Canvas(modifier = Modifier.fillMaxSize()) {
                    ...
                    fireworks.forEach { firework ->
                        ...
                        // Explosion phase
                            ...
                            // Use pre-generated sparks from firework model
...
private fun generateFireworks(count: Int): List<Firework> {
    return List(count) { index ->
        ...
        // Pre-generate sparks for this firework to avoid per-frame allocation
